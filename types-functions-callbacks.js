...
var minimum = function(num1,num2,num3,num4) {
	if ((num1 < num2) && (num1 < num3) && (num1 < num4)) {
 	...
 	else if ((num2 < num3) && (num2 < num3) && (num2 < num4)){
 		return num2
 	} else if (num3 < num4) {
 		return num3
 	} else return num4
...
var justOneString = function(inputOne,inputTwo) {
	if 	((inputOne !== typeof('String')) && (inputTwo !== typeof('String'))){
		return false
	} else if  
		((inputOne === typeof('String')) && (inputTwo === typeof('String'))) {
						return false
							} else {
								return true
					}
...
var conditionallyInvoke = function(funktion) {
	if (ORACLE === 'YES'){
		return funktion()
}
}
